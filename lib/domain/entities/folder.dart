...
class Folder implements SyncableEntity {
  const Folder({required this.id, required this.workspaceId, required this.name, required this.position, required this.createdAt, required this.updatedAt, required this.version, this.parentFolderId, this.deletedAt});
