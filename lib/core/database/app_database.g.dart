...
class Tag extends DataClass implements Insertable<Tag> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, name, color, createdAt, updatedAt, deletedAt, version);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Tag &&
...
class NoteTag extends DataClass implements Insertable<NoteTag> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, noteId, tagId, createdAt, updatedAt, deletedAt, version);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is NoteTag &&
...
class $AttachmentsTable extends Attachments
  ...
  @override
  late final GeneratedColumn<String> documentNodeId = GeneratedColumn<String>(
    'document_node_id',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('document_node_id')) {
      context.handle(
        _documentNodeIdMeta,
        documentNodeId.isAcceptableOrUnknown(
          data['document_node_id']!,
          _documentNodeIdMeta,
        ),
      );
    }
...
class Setting extends DataClass implements Insertable<Setting> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, key, valueJson, createdAt, updatedAt, deletedAt, version);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Setting &&
...
class $$FoldersTableTableManager
    extends
        RootTableManager<
          ...
          Folder,
          PrefetchHooks Function({bool parentFolderId, bool notesRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({parentFolderId = false, notesRefs = false}) {
            return PrefetchHooks(
              ...
              getPrefetchedDataCallback: (items) async {
                return [
                  if (notesRefs)
                    await $_getPrefetchedData<Folder, $FoldersTable, NoteRow>(
                      currentTable: table,
